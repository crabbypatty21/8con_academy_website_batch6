...
const ConLift = () => {
  ...
  const initiativesData = [
    ...
    {
      icon: <ArrowRight size={50} color="#39CC2F" strokeWidth={1.5} />,
  ...
  return (
    <div style={styles.container}>
      ...
      <header className={`header ${scrolled ? "scrolled" : ""}`}>
        <div className="header-container">
          ...
          <nav className="desktop-nav">
            ...
            <a href="#initiatives" className="nav-link" onClick={(e) => { e.preventDefault(); handleSmoothScroll("initiatives"); }}>
              Key Initiatives
            </a>
      ...
      {/* Initiatives Section (HAS TOP COLOR BAR) */}
      <section id="initiatives" ref={initiativesRef} style={styles.initiativesSection}>
        <div style={styles.container2}>
          <h2 style={styles.sectionTitle} className={`animate-on-scroll ${isAnimated("initiatives") ? "animate-slide-in-top" : ""}`}>
            ...
            {initiativesData.map((data, index) => {
              ...
              return (
                <div
                  ...
                  className={`animate-on-scroll ${isAnimated("initiatives") ? `animate-scale-in stagger-${index + 1}` : ""}`}
                  onMouseEnter={(e) => {
            ...
            {whyChooseData.map((data, index) => {
              ...
              return (
                <div
                  ...
                  className={`animate-on-scroll ${isAnimated("why-choose") ? `animate-zoom-in stagger-${index + 1}` : ""}`}
                  onMouseEnter={(e) => {
                    e.currentTarget.style.transform = "translateY(-12px) scale(1.02)";
                    e.currentTarget.style.boxShadow = `0 25px 50px rgba(0, 0, 0, 0.6), 0 15px 35px ${shadowGlow}`; 
                    e.currentTarget.style.borderColor = borderGlow; 
