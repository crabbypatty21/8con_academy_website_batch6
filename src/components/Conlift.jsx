...
const ConLift = () => {
  ...
  const initiativesData = [
    {
      ...
      title: "Scholarships for Underserved Filipinos",
      description: "Provide financial assistance to deserving individuals who demonstrate potential and determination but lack resources for quality education.",
      items: [
    ...
    },
    {
      ...
      title: "Training Programs & OJT",
      description: "Offer students real-world experience through On-the-Job Training programs at 8Con Academy, franchises, or partner companies.",
      items: [
    ...
    {
      icon: <ArrowRight size={50} color={isDark ? "#39CC2F" : "#059669"} strokeWidth={1.5} />,
      title: "Enrollment to Employment",
      description: "Graduates of Forex Derivative Course Level II are guided through career opportunities aligned with their skills and goals.",
      items: [
    ...
    },
    {
      ...
      title: "Government Grants & Partnerships",
      description: "Secure government funding to provide broader access to scholarships and training programs for marginalized communities.",
      items: [
  ...
  const benefitsData = [
    {
      ...
      description: "Provide access to education and training that equips beneficiaries with skills for lifelong success and personal growth."
    },
    {
      icon: <DollarSign size={50} color="#ff1f2c" strokeWidth={1.5} />,
      title: "Creating Career Pathways",
      description: "Through the 'Enrollment to Employment' program, graduates seamlessly transition from learning to earning, fostering financial independence."
    },
    {
      icon: <Building size={50} color={isDark ? "#39CC2F" : "#059669"} strokeWidth={1.5} />,
      title: "Strengthening Communities",
      description: "By uplifting individuals, 8ConLift contributes to the economic and social growth of communities across the Philippines."
    },
    {
      icon: <Heart size={50} color="#ff1f2c" strokeWidth={1.5} />,
      title: "Supporting Underserved Groups",
      description: "Scholarships, OJTs, and government grants ensure that even the most disadvantaged individuals have access to quality training and career opportunities."
    }
  ];
  ...
  const whyChooseData = [
    {
      ...
      description: "Beyond education, beneficiaries receive mentorship, hands-on training, and career placement support throughout their journey."
    },
    {
      icon: <Network size={50} color="#ff1f2c" strokeWidth={1.5} />,
      title: "Collaborative Growth",
      description: "By partnering with LGUs, businesses, and private firms, 8ConLift ensures sustainable support and impactful outcomes for beneficiaries."
    }
  ];
  ...
  return (
    <div style={styles.container}>
      ...
      <header className={`header ${scrolled ? "scrolled" : ""}`}>
        <div className="header-container">
          ...
          <nav className="desktop-nav">
            ...
            <button className="nav-link" onClick={() => handleSmoothScroll("initiatives")}>Key Initiatives</button>
        ...
        {mobileMenuOpen && (
          <nav className="mobile-nav">
            ...
            <button onClick={() => handleSmoothScroll("initiatives")} className="mobile-nav-link">Key Initiatives</button>
        ...
        <div style={styles.heroContent}>
          ...
          <div style={styles.heroForegroundContent}>
            ...
            <p style={styles.heroDescription} className="fade-in-up anim-delay-3">
              8ConLift is dedicated to empowering underserved Filipinos by providing scholarships, training programs, and pathways to financial independence. We believe in creating opportunities for individuals to build a better future through education and skill development.
            </p>
            <div style={styles.heroButtons} className="fade-in-up anim-delay-4">
              <button
                style={styles.ctaButtonPrimary}
                onClick={() => { window.location.href = "mailto:scholarships@8construct.com"; }}
                onMouseEnter={(e) => {
      ...
      {/* Initiatives Section */}
      <section id="initiatives" style={{ ...styles.sectionCommon, backgroundColor: colors.bgPrimary }}>
        <div style={styles.container2}>
          <h2 style={styles.sectionTitle} className="fade-in-up">
            KEY INITIATIVES UNDER <span style={{ color: isDark ? "#39CC2F" : "#059669" }}>8CONLIFT</span>
          </h2>
          ...
          <div className="grid-2x2">
            {benefitsData.map((data, index) => (
              <div key={index} className={`scale-up anim-delay-${(index % 4) + 1}`}>
                <div className="conlift-card" style={{ justifyContent: "center" }}>
                  <div>{data.icon}</div>
                  <h3 style={{ fontSize: "clamp(1.1rem, 3vw, 1.4rem)", fontFamily: "'Unbounded', sans-serif", fontWeight: "700", color: colors.textPrimary, marginBottom: "0.5rem" }}>{data.title}</h3>
                  <p style={{ fontSize: "clamp(0.9rem, 2.5vw, 1rem)", color: colors.textMuted, lineHeight: "1.6" }}>{data.description}</p>
                </div>
      ...
      <section id="why-choose" style={{ ...styles.sectionCommon, backgroundColor: colors.bgPrimary }}>
        <div style={styles.container2}>
          <h2 style={styles.sectionTitle} className="fade-in-up">
            WHY CHOOSE <span style={{ color: isDark ? "#39CC2F" : "#059669" }}>8CONLIFT?</span>
          </h2>
          <div className="flex-centered-grid">
            {whyChooseData.map((data, index) => (
              <div key={index} style={{ flex: "1 1 350px", maxWidth: "450px", width: "100%" }} className={`fade-in-up anim-delay-${(index % 2) + 1}`}>
                <div className="conlift-card" style={{ justifyContent: "center" }}>
                  <div>{data.icon}</div>
                  <h3 style={{ fontSize: "clamp(1.1rem, 3vw, 1.4rem)", fontFamily: "'Unbounded', sans-serif", fontWeight: "700", color: colors.textPrimary, marginBottom: "0.5rem" }}>{data.title}</h3>
                  <p style={{ fontSize: "clamp(0.9rem, 2.5vw, 1rem)", color: colors.textMuted, lineHeight: "1.6" }}>{data.description}</p>
      ...
      <section id="cta" style={{ ...styles.sectionCommon, backgroundColor: colors.bgSecondary, textAlign: "center" }}>
        <div style={styles.container2}>
          ...
          <p style={styles.ctaDescription} className="fade-in-up anim-delay-2">
            At 8ConLift, we believe in the power of education to change lives. Through scholarships, OJT opportunities, and our unique Enrollment to Employment Program, we are creating a future where financial independence and success are within reach for every Filipino.
          </p>
          <div style={styles.ctaButtons} className="fade-in-up anim-delay-3">
            ...
            <button
              ...
              onClick={() => { window.location.href = "mailto:partners@8construct.com"; }}
              onMouseEnter={(e) => {
                e.currentTarget.style.background = "#0edb61";
                e.currentTarget.style.transform = "translateY(-3px)";
          ...
          <div className="fade-in-up anim-delay-4" style={{ marginTop: "2rem" }}>
            ...
            >
              <strong>
                Join 8ConLift today—where dreams take flight and lives are transformed!
              </strong>
            </div>
          </div>
        </div>
