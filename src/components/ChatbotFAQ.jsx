...
import { MessageCircle, X, Send, ChevronLeft, Reply } from "lucide-react";
    ...
    faqs: [
      {
        ...
        answer: "All 8Con graduates are eligible for our Enrollment to Employment program. You can explore our available career paths by visiting the Career section of our website.",
      },
      {
        question: "How can I enroll in the Forex Derivative Course?",
        answer: "You may visit us personally at 8Con Academy, Meycauayan, Bulacan, or message us on our official Facebook fan page. We highly recommend attending our FREE Forex Workshop every Saturday as a first step before enrolling.",
      },
      {
        question: "Can I enroll without a trading background?",
        answer: "Yes! Our course is designed for beginners, so no prior experience is required.",
      },
      {
        question: "How long does the Forex Derivatives course take?",
        answer: "The course runs for a total of 276 hours. Most students complete it within 2 to 3 months, depending on your schedule and commitment.",
      },
      {
        question: "What are the requirements to start learning forex?",
        answer: "You just need basic comprehension skills and the tools for digital trading, such as a mobile phone with data or a laptop with internet connection.",
      },
      {
        question: "Do you offer scholarships?",
        answer: "Yes! We currently offer FULL SCHOLARSHIPS to all OJT interns and Private Scholars. However, Cooperative (Coop) Scholarships are on hold until further notice.",
      },
      {
        question: "Do I get a certificate after finishing the course?",
        answer: "Yes, a Certificate of Completion is issued to all successful graduates of the course.",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        answer: "We accept cash, bank transfer, and credit card payments via PayPal.",
      },
      {
    ...
    faqs: [
      {
        ...
        answer: "Absolutely! We encourage all prospective students to attend our FREE Forex Workshop and schedule a consultation to better understand the course.",
      },
      {
        question: "Do you offer corporate training?",
        answer: "Yes, we offer corporate training packages. We require a minimum of 10 participants per batch.",
      },
      {
...
const generalResponses = [
  {
    ...
    answer: "Hello! Welcome to 8Con Academy. How can I help you today? Feel free to ask me anything or pick from the categories.",
  },
  {
...
const ChatbotFAQ = () => {
  ...
  const handleCategoryClick = (category) => {
    ...
    setView("chat");
    setMessages([
      { from: "bot", text: `Here are some questions about ${category.name.toLowerCase()}. Pick one or type your own!` },
    ]);
  };
              ...
              <div className="chatbot-home">
                ...
                <div className="chatbot-categories">
                  {categories.map((cat, i) => (
                    ...
                    >
                      <div className="chatbot-category-icon">{cat.icon}</div>
            ...
            <>
              ...
              <div className="chatbot-messages">
                {messages.map((msg, i) => {
                  ...
                  const showAvatar =
                    isBot && (i === 0 || messages[i - 1]?.from !== "bot");
